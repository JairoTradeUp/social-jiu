...
const mockSearchProfiles = [
  { id: '2', name: 'Ana Paula Silva', belt: 'roxa', academy: 'Alliance SP', followers: '830 followers', followed: false },
  ...
  { id: '7', name: 'Gabriel Santos', belt: 'coral', academy: 'Alliance SP', followers: '3.4k followers', followed: false },
  { id: '8', name: 'Beatriz Ramos', belt: 'preta', academy: 'Alliance SP', followers: '1.2k followers', followed: false }
]
                        ...
                        <div className="p-3 z-10 w-full space-y-1.5">
                          ...
                          <div className="flex items-center justify-between border-t border-white/10 pt-1.5">
                            ...
                            <div className="flex items-center gap-2 text-white/80 shrink-0">
                              <div className="flex items-center gap-0.5">
                                <Heart size={10} fill="#d9434f" className="text-brand-red" />
                                <span className="text-[8px]">{item.likes}</span>
                              </div>
                            </div>
                          </div>
